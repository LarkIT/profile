...
#
# Renamed to lark_sorted_json to prevent any name collisions
require 'json'
...
module Puppet::Parser::Functions
  newfunction(:lark_sorted_json, :type => :rvalue, :doc => <<-EOS
...
*Examples:*
    ...
    lark_sorted_json(unsorted_hash)
    ...
    lark_sorted_json(unsorted_hash, true, 4)
