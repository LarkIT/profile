...
class profile::solr::server (
  ...
  if str2bool($::settings::storeconfigs) {
    ...
    @@firewall { "200 OUTPUT allow solr access at ${::ipaddress}:${port}":
      ...
      tag         => "fw_${trusted['extensions']['pp_environment']}_${::client}_${trusted['extensions']['pp_application']}_solr_out_to_solr_server",
    }
    # Allow inbound connections.
    Firewall <<| tag == "fw_${trusted['extensions']['pp_environment']}_${::client}_${trusted['extensions']['pp_application']}_solr_in_from_clients" |>>
    ...
    @@host { $::fqdn:
      ...
      ip           => $::ipaddress,
      tag          => "host_${trusted['extensions']['pp_environment']}_${::client}_${trusted['extensions']['pp_application']}_solr_server",
    }
  }
